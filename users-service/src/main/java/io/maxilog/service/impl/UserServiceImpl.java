...
import io.maxilog.service.mapper.Impl.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    @Inject
    public UserServiceImpl(@RestClient keycloakClient keycloakClient, UserMapper userMapper, UserHolder userHolder) {
